...
public class TestActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //DragNDropSimpleAdapter adapter = new DragNDropSimpleAdapter(getApplicationContext(), data, R.layout.text_view,  )
    ...
    private class Cheeses {

        public final String[] sCheeseStrings = {
